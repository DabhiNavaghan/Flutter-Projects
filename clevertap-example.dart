...
class _MyAppState extends State<MyApp> {
              ...
              children: <Widget>[
                ...
                Card(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(4.0),
                    child: ListTile(
                      title: Text('Get Variable Value for name \'folder1.fileVariable\''),
                ...
                Card(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(4.0),
                    child: ListTile(
                      title: Text('Add \'OnFileVariablesChangedAndNoDownloadsPending\' listener'),
                ...
                Card(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(4.0),
                    child: ListTile(
                      title: Text('Add \'OnceFileVariablesChangedAndNoDownloadsPending\' listener'),
                ...
                Card(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(4.0),
                    child: ListTile(
                      title: Text('Add \'OnFileChanged\' listener for name \'folder1.fileVariable\''),
                      onTap: onFileChanged,
                    ),
                  ),
                ),
  ...
  void showInbox() {
    if (inboxInitialized) {
      showToast("Opening App Inbox", onDismiss: () {
        var styleConfig = {'noMessageTextColor': '#ff6600', 'noMessageText': 'No message(s) to show.', 'navBarTitle': 'App Inbox', 'navBarTitleColor': '#101727', 'navBarColor': '#EF4444'};
  ...
  void onUserLogin() {
    var stuff = ["bags", "shoes"];
    var profile = {'Name': 'Captain America', 'Identity': '100', 'Email': 'captain@america.com', 'Phone': '+14155551234', 'stuff': stuff};
  ...
  void localAlertPushPrimer() {
    this.setState(() async {
      ...
      if (!isPushPermissionEnabled) {
        var pushPrimerJSON = {'inAppType': 'alert', 'titleText': 'Get Notified', 'messageText': 'Enable Notification permission', 'followDeviceOrientation': true, 'positiveBtnText': 'Allow', 'negativeBtnText': 'Cancel', 'fallbackToSettings': true};
        CleverTapPlugin.promptPushPrimer(pushPrimerJSON);
  ...
  void getFileVariable() async {
    ...
    print('PE -> variable value for key \'folder1.fileVariable\': ' + variable.toString());
  }
  ...
  void handleDeeplink(Map<String, dynamic> notificationPayload) {
    ...
    print("handleDeeplink => Type: $type, Title: $title, Message: $message ");

    if (type != null) {
      // Navigator.push(context, MaterialPageRoute(builder: (context) => DeepLinkPage(type: type, title: title, message: message)));
    }

    print("_handleKilledStateNotificationInteraction => Type: $type, Title: $title, Message: $message ");
  }
